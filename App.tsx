...
// A curated list of "banger" words and phrases for the random button, translated to German.
const PREDEFINED_WORDS = [
  ...
  'Ordnung und Chaos', 'Licht und Schatten', 'Klang und Stille', 'Form und Formlosigkeit', 'Sein und Nichtsein', 'Anwesenheit und Abwesenheit', 'Bewegung und Stille', 'Einheit und Vielfalt', 'Endlich und unendlich', 'Heilig und profan', 'Erinnerung und Vergessen', 'Frage und Antwort', 'Suche und Entdeckung', 'Reise und Ziel', 'Traum und Wirklichkeit', 'Zeit und Ewigkeit', 'Selbst und Andere', 'Bekannt und Unbekannt', 'Gesprochen und Ungesprochen', 'Sichtbar und Unsichtbar',
  // Liste 2
  'Zickzack', 'Wellen', 'Spirale', 'Abprall', 'Schräge', 'Tropfen', 'Dehnung', 'Quetschen', 'Schweben', 'Fallen', 'Drehen', 'Schmelzen', 'Aufsteigen', 'Verdrehen', 'Explodieren', 'Stapeln', 'Spiegel', 'Echo', 'Vibrieren',
  // Liste 3
  'Schwerkraft', 'Reibung', 'Impuls', 'Trägheit', 'Turbulenz', 'Druck', 'Spannung', 'Oszillieren', 'Fraktal', 'Quanten', 'Entropie', 'Wirbel', 'Resonanz', 'Gleichgewicht', 'Zentrifuge', 'Elastisch', 'Viskos', 'Brechen', 'Diffundieren', 'Kaskade', 'Levitieren', 'Magnetisieren', 'Polarisieren', 'Beschleunigen', 'Komprimieren', 'Wogen',
  // Liste 4
  'Liminal', 'Ephemer', 'Paradoxon', 'Zeitgeist', 'Metamorphose', 'Synästhesie', 'Rekursion', 'Emergenz', 'Dialektik', 'Apophänie', 'Schwebezustand', 'Fluss', 'Erhaben', 'Unheimlich', 'Palimpsest', 'Chimäre', 'Leere', 'Transzendieren', 'Unbeschreiblich', 'Qualia', 'Gestalt', 'Simulakrum', 'Abgründig',
  // Liste 5
  'Existenziell', 'Nihilismus', 'Solipsismus', 'Phänomenologie', 'Hermeneutik', 'Dekonstruktion', 'Postmodern', 'Absurdismus', 'Katharsis', 'Epiphanie', 'Melancholie', 'Nostalgie', 'Sehnsucht', 'Träumerei', 'Pathos', 'Ethos', 'Logos', 'Mythos', 'Anamnese', 'Intertextualität', 'Metafiktion', 'Strom', 'Lücke', 'Zäsur', 'Enjambement'
];
    ...
    <div>
      ...
      <footer className="sticky-footer">
        <p className="footer-text" style={{ margin: 0 }}>
          Infinite Wiki von Rudolf Bewer · Generiert von Gemini 2.5 Flash
